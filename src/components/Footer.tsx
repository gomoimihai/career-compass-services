      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-gray-600 hover:text-teal">About</Link></li>
              <li><Link to="/services" className="text-gray-600 hover:text-teal">Services</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-2">Email: hello@careergrowth.com</p>
        ...
        <div className="border-t border-gray-200 pt-8">
          <p className="text-sm text-gray-500 text-center">
            &copy; {new Date().getFullYear()} Career Growth. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
